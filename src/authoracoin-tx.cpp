...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Authoracoin Core authoracoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  authoracoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded authoracoin transaction") + "\n" +
                               "  authoracoin-tx [options] -create [commands]   " + _("Create hex-encoded authoracoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded authoracoin transaction
