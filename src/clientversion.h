...
//! These need to be macros, as clientversion.cpp's and authoracoin*-res.rc's voodoo requires it
...
/**
 * authoracoind-res.rc includes this file, but it cannot cope with real c++ code.
