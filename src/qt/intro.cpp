...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Authoracoin Core"),
     ...
     * override -datadir in the authoracoin.conf file in the default data directory
     * (to be consistent with authoracoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
