                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Authoracoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ATHR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and authoracoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Authoracoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Authoracoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Authoracoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ATHR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ATHR addresses"));
    ...
    openAction->setStatusTip(tr("Open a authoracoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Authoracoin Core help message to get a list with possible Authoracoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Authoracoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Authoracoin network", "", count));
}
...
{
    QString strTitle = tr("Authoracoin Core"); // default title
