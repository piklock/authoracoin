...
#   c) node1 mines 32 blocks, so now node 0 has 500000ATH, node 1 has 4250ATH, node2 has none.
#   d) node0 sends 601 ATHR to node2, in two transactions (301 ATHR, then 300 ATHR).
