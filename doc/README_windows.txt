...
high-powered mining hardware. Authoracoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run authoracoin-qt.exe.

Authoracoin Core is the original Authoracoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Authoracoin transactions;
